...
function AddCard(props) {
    ...
    return (
        ...
        {showDelayedText[0]}
            ...
            <button onClick={
                async() => {//setShowModal(false);
                       //console.log(obj);
                       let obj = await axios.get('https://rrr-back-5615f255bc1e.herokuapp.com/get_save_card');
                       let result = await axios.post('https://rrr-back-5615f255bc1e.herokuapp.com/add_card', obj.data);
                       setShowDelayedText(['Карточка', 'была', 'добавлена']);
                       await axios.get('https://rrr-back-5615f255bc1e.herokuapp.com/delay');
                       //sleep(3000);
                       setShowModal(false);
      ...
      <form onSubmit={
        ...
        await createID();
        let result = await axios.post('https://rrr-back-5615f255bc1e.herokuapp.com/save_card', {data})
        //console.log(obj);
