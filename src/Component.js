  ...
  useState(['Вы уверены?', 'Да', 'Нет']); 
    ...
    >
      ...
      <button onClick={async() => {
        ...
        setShowModal(false);
        await axios.get(`https://rrr-back-5615f255bc1e.herokuapp.com/delete_card/${id}/`);
        setLength(await axios.get('https://rrr-back-5615f255bc1e.herokuapp.com/get_length_bd'));
